...
#define DSIH_FIFO_ACTIVE_WAIT  1000    /* no of tries to access the fifo */
#define DSIH_READ_DATA_WAIT_MS 200
#define DSIH_PHY_ACTIVE_WAIT   50000
#define DEFAULT_BYTE_CLOCK     500000  /* a value to start PHY PLL - random */
