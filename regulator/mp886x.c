...
/**
 * mp886x_set_ramp_delay_regmap - set_ramp_delay() helper
 * mimic regulator_set_ramp_delay_regmap behavior
 *
 ...
 */
static int mp886x_set_ramp_delay_regmap(struct regulator_dev *rdev, int ramp_delay)
{
	int ret;
	unsigned int sel;
...
static const struct regulator_ops mp8869_regulator_ops = {
	...
	.set_ramp_delay = mp886x_set_ramp_delay_regmap,
