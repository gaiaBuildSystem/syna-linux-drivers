...
module_param(showArgs, int, 0644);
    ...
    unsigned long coreClock = 187500000;
...
#endif
{
...
#if ENABLE_GPU_CLOCK_BY_DRIVER && (LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,28))
    {
         ...
         * Use the 2X clock.
         */
        rate = clk_round_rate(clk, coreClock * 2);
...
#else
static void drv_exit(struct platform_device *pdev)
#endif
{
    gcmkHEADER();
...
static struct of_device_id gpu_of_ids[] = {
