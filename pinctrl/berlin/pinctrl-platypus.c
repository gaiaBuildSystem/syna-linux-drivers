...
/*
 * Synaptics PLATYPUS pinctrl driver
 *
...
static const struct berlin_desc_group platypus_soc_pinctrl_groups[] = {
...
static const struct berlin_desc_group platypus_avio_pinctrl_groups[] = {
...
static const struct berlin_desc_group platypus_sysmgr_pinctrl_groups[] = {
...
static const struct berlin_pinctrl_desc platypus_soc_pinctrl_data = {
	.groups = platypus_soc_pinctrl_groups,
	.ngroups = ARRAY_SIZE(platypus_soc_pinctrl_groups),
};

static const struct berlin_pinctrl_desc platypus_avio_pinctrl_data = {
	.groups = platypus_avio_pinctrl_groups,
	.ngroups = ARRAY_SIZE(platypus_avio_pinctrl_groups),
};

static const struct berlin_pinctrl_desc platypus_sysmgr_pinctrl_data = {
	.groups = platypus_sysmgr_pinctrl_groups,
	.ngroups = ARRAY_SIZE(platypus_sysmgr_pinctrl_groups),
};

static const struct of_device_id platypus_pinctrl_match[] = {
	{
		.compatible = "syna,platypus-soc-pinctrl",
		.data = &platypus_soc_pinctrl_data,
	},
	{
		.compatible = "syna,platypus-avio-pinctrl",
		.data = &platypus_avio_pinctrl_data,
	},
	{
		.compatible = "syna,platypus-system-pinctrl",
		.data = &platypus_sysmgr_pinctrl_data,
	},
	{}
};
...
static int platypus_pinctrl_probe(struct platform_device *pdev)
{
	const struct of_device_id *match =
		of_match_device(platypus_pinctrl_match, &pdev->dev);
...
static const struct dev_pm_ops platypus_pinctrl_pm_ops = {
	SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(berlin_pinctrl_suspend, berlin_pinctrl_resume)
};

static struct platform_driver platypus_pinctrl_driver = {
	.probe	= platypus_pinctrl_probe,
	.driver	= {
		.name = "platypus-pinctrl",
		.pm = &platypus_pinctrl_pm_ops,
...
MODULE_DESCRIPTION("pinctrl driver for Synaptics platypus SoC");
