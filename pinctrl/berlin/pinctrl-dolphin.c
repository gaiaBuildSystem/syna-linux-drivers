...
/*
 * Synaptics DOLPHIN pinctrl driver
 *
...
static const struct berlin_desc_group dolphin_soc_pinctrl_groups[] = {
...
static const struct berlin_desc_group dolphin_avio_pinctrl_groups[] = {
...
static const struct berlin_desc_group dolphin_sysmgr_pinctrl_groups[] = {
...
static int dolphin_pinctrl_probe(struct platform_device *pdev)
{
	const struct of_device_id *match =
		of_match_device(dolphin_pinctrl_match, &pdev->dev);
...
static const struct dev_pm_ops dolphin_pinctrl_pm_ops = {
	SET_NOIRQ_SYSTEM_SLEEP_PM_OPS(berlin_pinctrl_suspend, berlin_pinctrl_resume)
};

static struct platform_driver dolphin_pinctrl_driver = {
	.probe	= dolphin_pinctrl_probe,
	.driver	= {
		.name = "dolphin-pinctrl",
		.pm = &dolphin_pinctrl_pm_ops,
...
MODULE_DESCRIPTION("pinctrl driver for Synaptics DOLPHIN SoC");
