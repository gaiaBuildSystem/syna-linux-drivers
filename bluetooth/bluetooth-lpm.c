...
MODULE_DEVICE_TABLE(of, bt_bluesleep_table);
...
#define BT_WAKE_DELAY_IN_MS	1200
...
static DECLARE_DELAYED_WORK(bs_work, bluesleep_dev_wake_work);
...
static int bluesleep_resume(struct platform_device *pdev)
{
	...
	schedule_delayed_work(&bs_work, msecs_to_jiffies(BT_WAKE_DELAY_IN_MS));
