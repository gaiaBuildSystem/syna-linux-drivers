...
#define MYNA_AXI_PCNT_CTRL			0x0048
#define MYNA_MST0_0_PCNT			0x0064
#define MYNA_MST0_1_PCNT			0x0098
#define MYNA_AXI_MST0_0			0x004C
#define MYNA_MC_CNT_CTRL			0x0240
#define MYNA_MC_CNT_CTRL1			0x0244
#define MYNA_MC_CNT_CTRL2			0x0248
#define MYNA_MC_WRAP_PC0			0x0250
#define MYNA_MC_WRAP_PC1			0x0258

#define MYNA2_AXI_PCNT_CTRL			0x0048
#define MYNA2_MST0_0_PCNT			0x0064
#define MYNA2_MST0_1_PCNT			0x0098
#define MYNA2_AXI_MST0_0			0x004C
#define MYNA2_MC_CNT_CTRL			0x0240
#define MYNA2_MC_CNT_CTRL1			0x0244
#define MYNA2_MC_CNT_CTRL2			0x0248
#define MYNA2_MC_WRAP_PC0			0x0250
#define MYNA2_MC_WRAP_PC1			0x0258

#define PLATYPUS_AXI_PCNT_CTRL			0x0048
#define PLATYPUS_AXI_PCNT_CTRL1			0x004C
#define PLATYPUS_AXI_MST0_0			0x0050
#define PLATYPUS_MST0_0_PCNT			0x0080
#define PLATYPUS_MST0_1_PCNT			0x00B4
#define PLATYPUS_MC_CNT_CTRL			0x03D4
#define PLATYPUS_MC_CNT_CTRL1			0x03D8
#define PLATYPUS_MC_CNT_CTRL2			0x03DC
...
static const u32 myna_axi_cnt_ctrl_bit[MYNA_AXI_CNT_NUM + 1] =
{
	BIT(0),
	BIT(1),
	BIT(2),
	...
	BIT(4),
	BIT(5),
	BIT(MYNA_AXI_CNT_NUM) - 1,
};

static const u32 myna2_axi_cnt_ctrl_bit[MYNA2_AXI_CNT_NUM + 1] =
{
	BIT(0),
	BIT(1),
	BIT(2),
	...
	BIT(4),
	BIT(5),
	BIT(MYNA2_AXI_CNT_NUM) - 1,
};

static const u32 platypus_axi_cnt_ctrl_bit[PLATYPUS_AXI_CNT_NUM + 1] =
{
	BIT(0),
	BIT(1),
	BIT(2),
	...
	BIT(10),
	BIT(11),
	BIT(PLATYPUS_AXI_CNT_NUM) - 1,
};

static const u32 dolphin_axi_cnt_ctrl_bit[DOLPHIN_AXI_CNT_NUM + 1] =
{
	BIT(0),
	BIT(1),
	BIT(2),
...
static const u32 myna_axi_default_id[MYNA_AXI_CNT_NUM] =
{
...
static const u32 myna2_axi_default_id[MYNA2_AXI_CNT_NUM] =
{
	(0x0003 << 16) + 0x0000,       /* Mstr0_0: CPU */
	(0x0003 << 16) + 0x0003,       /* Mstr0_1: MTEST */
	(0x0003 << 16) + 0x0001,       /* Mstr0_2: DXBAR (CS, PXBAR(EMMC+SDIO+USB2+PB), TXBAR(BCMx)) */
...
static const u32 dolphin_axi_default_id[DOLPHIN_AXI_CNT_NUM] =
{
...
static const struct cnt_hw_data myna_hw_data =
{
	.type = MYNA_AXI_MC_TYPE,
	/* mc counter content */
	.ctl_off =  {	MYNA_MC_CNT_CTRL,
			0
		    },
	.ctl1_off = {	MYNA_MC_CNT_CTRL1,
			0
		    },
	.ctl2_off = {	MYNA_MC_CNT_CTRL2,
			0
		    },
	.pc0_off =  {	MYNA_MC_WRAP_PC0,
			0
		    },
	.pc1_off =  {	MYNA_MC_WRAP_PC1,
			0
		    },
	.ovf_off =  {	MYNA_MC_WRAP_PC0 + 4,
			0
		    },
	.mc_cnt_num = MYNA_MC_CNT_NUM,

	/* axi counter content */
	.axi_cnt_num = MYNA_AXI_CNT_NUM,
	.ctl_bit = myna_axi_cnt_ctrl_bit,
	.ctl_all = BIT(MYNA_AXI_CNT_NUM) - 1,
	.mst_off = MYNA_AXI_MST0_0,
	.def_id = myna_axi_default_id,
	.latch_base = MYNA_AXI_PCNT_CTRL,
	.latch_lsf = 12,
	.en_base = MYNA_AXI_PCNT_CTRL,
	.en_lsf = 6,
	.clr_base = MYNA_AXI_PCNT_CTRL,
	.clr_lsf = 0,
	.axi_cnt_dist = MYNA_MST0_1_PCNT - MYNA_MST0_0_PCNT,
	.axi_cnt_off = MYNA_MST0_0_PCNT,
};

static const struct cnt_hw_data myna2_hw_data =
{
	.type = MYNA2_AXI_MC_TYPE,
	/* mc counter content */
	.ctl_off =  {	MYNA2_MC_CNT_CTRL,
			0
		    },
	.ctl1_off = {	MYNA2_MC_CNT_CTRL1,
			0
		    },
	.ctl2_off = {	MYNA2_MC_CNT_CTRL2,
			0
		    },
	.pc0_off =  {	MYNA2_MC_WRAP_PC0,
			0
		    },
	.pc1_off =  {	MYNA2_MC_WRAP_PC1,
			0
		    },
	.ovf_off =  {	MYNA2_MC_WRAP_PC0 + 4,
			0
		    },
	.mc_cnt_num = MYNA2_MC_CNT_NUM,

	/* axi counter content */
	.axi_cnt_num = MYNA2_AXI_CNT_NUM,
	.ctl_bit = myna2_axi_cnt_ctrl_bit,
	.ctl_all = BIT(MYNA2_AXI_CNT_NUM) - 1,
	.mst_off = MYNA2_AXI_MST0_0,
	.def_id = myna2_axi_default_id,
	.latch_base = MYNA2_AXI_PCNT_CTRL,
	.latch_lsf = 12,
	.en_base = MYNA2_AXI_PCNT_CTRL,
	.en_lsf = 6,
	.clr_base = MYNA2_AXI_PCNT_CTRL,
	.clr_lsf = 0,
	.axi_cnt_dist = MYNA2_MST0_1_PCNT - MYNA2_MST0_0_PCNT,
	.axi_cnt_off = MYNA2_MST0_0_PCNT,
};

static const struct cnt_hw_data platypus_hw_data =
{
	.type = PLATYPUS_AXI_MC_TYPE,
	/* mc counter content */
	.ctl_off =  {	PLATYPUS_MC_CNT_CTRL,
			0
		    },
	.ctl1_off = {	PLATYPUS_MC_CNT_CTRL1,
			0
		    },
	.ctl2_off = {	PLATYPUS_MC_CNT_CTRL2,
			0
		    },
	.pc0_off =  {	PLATYPUS_MC_WRAP_PC0,
			0
		    },
	.pc1_off =  {	PLATYPUS_MC_WRAP_PC1,
			0
		    },
	.ovf_off =  {	PLATYPUS_MC_WRAP_PC0 + 4,
			0
		    },
	.mc_cnt_num = PLATYPUS_MC_CNT_NUM,

	/* axi counter content */
	.axi_cnt_num = PLATYPUS_AXI_CNT_NUM,
	.ctl_bit = platypus_axi_cnt_ctrl_bit,
	.ctl_all = BIT(PLATYPUS_AXI_CNT_NUM) - 1,
	.mst_off = PLATYPUS_AXI_MST0_0,
	.def_id = platypus_axi_default_id,
	.latch_base = PLATYPUS_AXI_PCNT_CTRL1,
	.latch_lsf = 0,
	.en_base = PLATYPUS_AXI_PCNT_CTRL,
	.en_lsf = 12,
	.clr_base = PLATYPUS_AXI_PCNT_CTRL,
	.clr_lsf = 0,
	.axi_cnt_dist = PLATYPUS_MST0_1_PCNT - PLATYPUS_MST0_0_PCNT,
	.axi_cnt_off = PLATYPUS_MST0_0_PCNT,
};

static const struct cnt_hw_data dolphin_hw_data =
{
	.type = DOLPHIN_AXI_MC_TYPE,
	/* mc counter content */
	...
	.mc_cnt_num = DOLPHIN_MC_CNT_NUM,

	/* axi counter content */
	.axi_cnt_num = DOLPHIN_AXI_CNT_NUM,
	.ctl_bit = dolphin_axi_cnt_ctrl_bit,
	.ctl_all = BIT(DOLPHIN_AXI_CNT_NUM) - 1,
	.mst_off = RA_mc_wrap_AxiMst0_0,
	.def_id = dolphin_axi_default_id,
...
static const struct of_device_id syna_axi_meter_dt_ids[] = {
	...
	{ .compatible = "syna,dolphin-axi-meter",
	  .data = &dolphin_hw_data},
	{ .compatible = "syna,myna-axi-meter",
	  .data = &myna_hw_data},
	{ .compatible = "syna,myna2-axi-meter",
	  .data = &myna2_hw_data},
...
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(6, 11, 0))
	axi_meter->drv_class = class_create(MC_DEVICE_NAME);
#else
...
static RET syna_axi_meter_remove(struct platform_device *pdev)
{
	struct device *dev = &pdev->dev;
	struct axi_meter_priv *axi_meter;
