...
/*Total size = 0x4000 = 16384*/
#define AIO_DHUB_I2S1_R_SIZE		(1024)
#define AIO_DHUB_I2S1_W_SIZE		(1024)
#define AIO_DHUB_I2S2_R_SIZE		(1024)
#define AIO_DHUB_I2S2_W_SIZE		(1024)
#define AIO_DHUB_I2S3_R_SIZE		(1024)
...
#define AIO_DHUB_SPDI_R_SIZE		(1024)
#define AIO_DHUB_SPDI_W_SIZE		(1024)
...
#define AIO_DHUB_PDM_W_BASE 		(AIO_DHUB_I2S3_W_BASE+AIO_DHUB_I2S3_W_SIZE)
#define AIO_DHUB_PDM_R_BASE 		(AIO_DHUB_PDM_W_BASE+AIO_DHUB_PDM_W_SIZE)
#define AIO_DHUB_BCM_R_BASE 		(AIO_DHUB_PDM_R_BASE+AIO_DHUB_PDM_R_SIZE)
#define AIO_DHUB_SPDI_R_BASE		(AIO_DHUB_BCM_R_BASE+AIO_DHUB_BCM_R_SIZE)
#define AIO_DHUB_SPDI_W_BASE		(AIO_DHUB_SPDI_R_BASE+AIO_DHUB_SPDI_R_SIZE)
