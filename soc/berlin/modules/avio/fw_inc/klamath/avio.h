...
#ifndef h_BCMQMap
#define h_BCMQMap (){}
    #define        BCMQMap_AIO_event0                                       0x0
    #define        BCMQMap_AIO_event1                                       0x1
    #define        BCMQMap_AIO_event2                                       0x2
    #define        BCMQMap_AIO_event3                                       0x3
    #define        BCMQMap_AIO_event4                                       0x4
    #define        BCMQMap_AIO_event5                                       0x5
    #define        BCMQMap_AIO_event6                                       0x6
    #define        BCMQMap_AIO_event7                                       0x7
    #define        BCMQMap_AIO_event8                                       0x8
    #define        BCMQMap_AIO_event9                                       0x9
    #define        BCMQMap_AIO_event10                                      0xA
    #define        BCMQMap_AIO_event11                                      0xB
    #define        BCMQMap_AIO_event12                                      0xC
    #define        BCMQMap_AIO_event13                                      0xD
    #define        BCMQMap_AIO_event14                                      0xE
    #define        BCMQMap_AIO_event15                                      0xF
    #define        BCMQMap_AIO_event16                                      0x10
    #define        BCMQMap_AIO_event17                                      0x11
    #define        BCMQMap_AIO_event18                                      0x12
    #define        BCMQMap_AIO_event19                                      0x13
    #define        BCMQMap_AIO_event20                                      0x14
    #define        BCMQMap_AIO_event21                                      0x15
    #define        BCMQMap_AIO_event22                                      0x16
    #define        BCMQMap_AIO_event23                                      0x17
    #define        BCMQMap_AIO_event24                                      0x18
    #define        BCMQMap_AIO_event25                                      0x19
    #define        BCMQMap_AIO_event26                                      0x1A
    #define        BCMQMap_AIO_event27                                      0x1B
    #define        BCMQMap_AIO_event28                                      0x1C
    #define        BCMQMap_AIO_event29                                      0x1D
    #define        BCMQMap_AIO_event30                                      0x1E
    #define        BCMQMap_AIO_event31                                      0x1F
    #define        BCMQMap_VPP_event0                                       0x0
    #define        BCMQMap_VPP_event1                                       0x1
    #define        BCMQMap_VPP_event2                                       0x2
    #define        BCMQMap_VPP_event3                                       0x3
    #define        BCMQMap_VPP_event4                                       0x4
    #define        BCMQMap_VPP_event5                                       0x5
    #define        BCMQMap_VPP_event6                                       0x6
    #define        BCMQMap_VPP_event7                                       0x7
    #define        BCMQMap_VPP_event8                                       0x8
    #define        BCMQMap_VPP_event9                                       0x9
    #define        BCMQMap_VPP_event10                                      0xA
    #define        BCMQMap_VPP_event11                                      0xB
    #define        BCMQMap_VPP_event12                                      0xC
    #define        BCMQMap_VPP_event13                                      0xD
    #define        BCMQMap_VPP_event14                                      0xE
    #define        BCMQMap_VPP_event15                                      0xF
    #define        BCMQMap_VPP_event16                                      0x10
    #define        BCMQMap_VPP_event17                                      0x11
    #define        BCMQMap_VPP_event18                                      0x12
    #define        BCMQMap_VPP_event19                                      0x13
    #define        BCMQMap_VPP_event20                                      0x14
    #define        BCMQMap_VPP_event21                                      0x15
    #define        BCMQMap_VPP_event22                                      0x16
    #define        BCMQMap_VPP_event23                                      0x17
    #define        BCMQMap_VPP_event24                                      0x18
    #define        BCMQMap_VPP_event25                                      0x19
    #define        BCMQMap_VPP_event26                                      0x1A
    #define        BCMQMap_VPP_event27                                      0x1B
    #define        BCMQMap_VPP_event28                                      0x1C
    #define        BCMQMap_VPP_event29                                      0x1D
    #define        BCMQMap_VPP_event30                                      0x1E
    #define        BCMQMap_VPP_event31                                      0x1F
    #define        BCMQMap_VIP_event0                                       0x0
    #define        BCMQMap_VIP_event1                                       0x1
    #define        BCMQMap_VIP_event2                                       0x2
    #define        BCMQMap_VIP_event3                                       0x3
    #define        BCMQMap_VIP_event4                                       0x4
    #define        BCMQMap_VIP_event5                                       0x5
    #define        BCMQMap_VIP_event6                                       0x6
    #define        BCMQMap_VIP_event7                                       0x7
    #define        BCMQMap_VIP_event8                                       0x8
    #define        BCMQMap_VIP_event9                                       0x9
    #define        BCMQMap_VIP_event10                                      0xA
    #define        BCMQMap_VIP_event11                                      0xB
    #define        BCMQMap_VIP_event12                                      0xC
    #define        BCMQMap_VIP_event13                                      0xD
    #define        BCMQMap_VIP_event14                                      0xE
    #define        BCMQMap_VIP_event15                                      0xF
    #define        BCMQMap_VIP_event16                                      0x10
    #define        BCMQMap_VIP_event17                                      0x11
    #define        BCMQMap_VIP_event18                                      0x12
    #define        BCMQMap_VIP_event19                                      0x13
    #define        BCMQMap_VIP_event20                                      0x14
    #define        BCMQMap_VIP_event21                                      0x15
    #define        BCMQMap_VIP_event22                                      0x16
    #define        BCMQMap_VIP_event23                                      0x17
    #define        BCMQMap_VIP_event24                                      0x18
    #define        BCMQMap_VIP_event25                                      0x19
    #define        BCMQMap_VIP_event26                                      0x1A
    #define        BCMQMap_VIP_event27                                      0x1B
    #define        BCMQMap_VIP_event28                                      0x1C
    #define        BCMQMap_VIP_event29                                      0x1D
    #define        BCMQMap_VIP_event30                                      0x1E
    #define        BCMQMap_VIP_event31                                      0x1F
    typedef struct SIE_BCMQMap {
            UNSG32 u_AIO                                       :  5;
            UNSG32 RSVDx0_b5                                   : 27;
            UNSG32 u_VPP                                       :  5;
            UNSG32 RSVDx4_b5                                   : 27;
     ...
     SIGN32 BCMQMap_drvrd(SIE_BCMQMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst);
     SIGN32 BCMQMap_drvwr(SIE_BCMQMap *p, UNSG32 base, SIGN32 mem, SIGN32 tst, UNSG32 *pcmd);
       void BCMQMap_reset(SIE_BCMQMap *p);
     SIGN32 BCMQMap_cmp  (SIE_BCMQMap *p, SIE_BCMQMap *pie, char *pfx, void *hLOG, SIGN32 mem, SIGN32 tst);
    #define BCMQMap_check(p,pie,pfx,hLOG) BCMQMap_cmp(p,pie,pfx,(void*)(hLOG),0,0)
    #define BCMQMap_print(p,    pfx,hLOG) BCMQMap_cmp(p,0,  pfx,(void*)(hLOG),0,0)
#endif
#ifdef __cplusplus
  }
#endif
