		...
		)
{
	...
	if (0 != updSemId) {
		...
		cmd.uDESC_ovrdQos = AVIO_DHUB_DESC_OVRDQOS;
		cmd.uDESC_disSem  = 0;
		cmd.uDESC_qosSel  = AVIO_DHUB_DESC_QOSSEL;
	}
 ...
 *******************************************************************************/
static void dhub_channel_clear_bcmbuf(void *hdl,	/*Handle to HDL_dhub */
				   SIGN32 id,	/*Channel ID in $dHubReg */
				   VIP_BCMBUF * pbcmbuf)
{
	HDL_dhub *dhub = (HDL_dhub *) hdl;
...
static UNSG32 dhub_channel_enable_bcmbuf(void *hdl,	/*Handle to HDL_dhub */
				  SIGN32 id,	/*Channel ID in $dHubReg */
				  SIGN32 enable,	/*0 to disable, 1 to enable */
				  VIP_BCMBUF *pbcmbuf)
{
...
static void hbo_queue_clear_bcmbuf(void *hdl,	/*      Handle to HDL_hbo */
				SIGN32 id,	/*      Queue ID in $HBO */
				VIP_BCMBUF *pbcmbuf)
{
	HDL_hbo *hbo = (HDL_hbo *) hdl;
...
static UNSG32 hbo_queue_enable_bcmbuf(void *hdl,	/*      Handle to HDL_hbo */
				   SIGN32 id,	/*      Queue ID in $HBO */
				   SIGN32 enable,	/*      0 to disable, 1 to enable */
				   VIP_BCMBUF *pbcmbuf)
{
...
static void dhub2d_channel_clear_bcmbuf(void *hdl,	/*      Handle to HDL_dhub2d */
				 SIGN32 id,	/*      Channel ID in $dHubReg2D */
				 VIP_BCMBUF *pbcmbuf)
{
	HDL_dhub2d *dhub2d = (HDL_dhub2d *) hdl;
...
static void dhub2nd_channel_clear_bcmbuf(void *hdl, SIGN32 id, VIP_BCMBUF *pbcmbuf)
{
	HDL_dhub2d *dhub2d = (HDL_dhub2d *)hdl;
	UNSG32 a;
