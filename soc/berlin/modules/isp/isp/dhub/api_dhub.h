...
#include    "ctypes.h"
    ...
    UNSG64          ra;                                 /*! Base address of $dHub2D !*/
...
/* KLAMATH_KERNEL: Removed avioDhub.h dependency */
#include "avioDhub.h"
#if 0
/* KLAMATH_KERNEL: Type definitions extracted from removed avioDhub.h */
 ...
 */
    ...
    ******************************************************************************************************************/
    void    semaphore_hdl(
                        UNSG64      ra,                 /*! Base address of a BIU instance of $SemaHub !*/
 ...
 */
    ...
    ******************************************************************************************************************/
    void    hbo_hdl(    UNSG64      mem,                /*! Base address of HBO SRAM !*/
                        UNSG64      ra,                 /*! Base address of a BIU instance of $HBO !*/
    ...
    ******************************************************************************************************************/
    ...
    #define hbo_queue_chk_full(hdl,id)                                                                  \
              isp_semaphore_chk_full(hbo_fifoCtl(hdl),id)
 ...
 */
    ...
    ******************************************************************************************************************/
    void    dhub_hdl(   UNSG64      mem,                /*! Base address of dHub.HBO SRAM !*/
                        UNSG64      ra,                 /*! Base address of a BIU instance of $dHub !*/
  ...
  //removed connection from HBO interrupt to semaphore
    ...
    //        semaphore_intr_enable     (isp_dhub_semaphore(hdl),0,empty,full,almostEmpty,almostFull,cpu)

    #define dhub_channel_intr_enable    (hdl,id,full,cpu)                                                           \
              semaphore_intr_enable     (isp_dhub_semaphore(hdl),dhub_id2intr(id),0,full,0,0,cpu)
 ...
 */
    ...
    ******************************************************************************************************************/
    void    dhub2d_hdl( UNSG64      mem,                /*! Base address of dHub2D.dHub.HBO SRAM !*/
                        UNSG64      ra,                 /*! Base address of a BIU instance of $dHub2D !*/
...
void audio_dhub_clear(int ch);
void startSPDIFTxDhub(unsigned int puiTxBuf, int buff_size, HDL_semaphore **ppSemHandle);
