...
ifeq ($(or $(ISP_VI200),$(ISP_VI200_V2)),1)
MIPI_VERSION := DWC
...
ifeq ($(ISP_VERSION), $(findstring $(ISP_VERSION), ISP8000_V2108 ISP8000_V2202 ISP8000_V2203 ISP8200L_V2304 ISP8210L_V2302 ISP8000L_V2305 ISP8200_V2303 ISP8000_V2308 ISP8200_V2311 ISP8000L_V2310 ISP8000L_V2002 ISP8000NANO_V2302))
...
else ifeq ($(or $(ISP_VI200),$(ISP_VI200_V2)),1)

ifeq ($(ISP_TRIPLE_CORES), 1)
EXTRA_CFLAGS += -DVVCAM_ISP0_BASE=0xDD400000
EXTRA_CFLAGS += -DVVCAM_ISP1_BASE=0xDD000000
EXTRA_CFLAGS += -DVVCAM_ISP2_BASE=0xDD500000
else
EXTRA_CFLAGS += -DVVCAM_ISP0_BASE=0xDD000000
EXTRA_CFLAGS += -DVVCAM_ISP1_BASE=0xDE800000
EXTRA_CFLAGS += -DVVCAM_ISP2_BASE=0xDDFFFFFF
endif

EXTRA_CFLAGS += -DVVCAM_VI0_BASE=0xDD100000
EXTRA_CFLAGS += -DVVCAM_VI0_IRQ=16

EXTRA_CFLAGS += -DVVCAM_VI1_BASE=0xDD110000
EXTRA_CFLAGS += -DVVCAM_VI1_IRQ=16
EXTRA_CFLAGS += -DVVCAM_VI_REG_SIZE=0x10000
else

ifeq ($(ISP_TRIPLE_CORES), 1)
EXTRA_CFLAGS += -DVVCAM_ISP0_BASE=0xDE400000
EXTRA_CFLAGS += -DVVCAM_ISP1_BASE=0xDE000000
EXTRA_CFLAGS += -DVVCAM_ISP2_BASE=0xDE500000
else
EXTRA_CFLAGS += -DVVCAM_ISP0_BASE=0xDE000000
EXTRA_CFLAGS += -DVVCAM_ISP1_BASE=0xDE100000
EXTRA_CFLAGS += -DVVCAM_ISP2_BASE=0xDEFFFFFF
endif
