...
typedef struct amp_message_queue {
	...
	CC_MSG_t *pMsg;
	 ...
	 int(*Add) (struct amp_message_queue * pMsgQ, CC_MSG_t * pMsg);
...
int AMPMsgQ_DequeueRead(AMPMsgQ_t * pMsgQ, CC_MSG_t * pMsg);
...
int AMPMsgQ_Add(AMPMsgQ_t * pMsgQ, CC_MSG_t * pMsg);
int AMPMsgQ_ReadTry(AMPMsgQ_t * pMsgQ, CC_MSG_t * pMsg);
