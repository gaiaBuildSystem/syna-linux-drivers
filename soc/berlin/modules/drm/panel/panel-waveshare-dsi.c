...
#else
static int ws_panel_probe(struct i2c_client *i2c, const struct i2c_device_id *id)
#endif
{
...
//	ws_panel_enable(&ts->base);
	return 0;
}

static RET_TYPE ws_panel_remove(struct i2c_client *i2c)
{
