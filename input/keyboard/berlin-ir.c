...
static struct ir_keymap keymap_tab[] = {
	...
	/* Google RC G20 */
	MAKE_IR_KEYMAP(MV_IR_KEY_BOOKMARKS,     0, KEY_BOOKMARKS),
	MAKE_IR_KEYMAP(MV_IR_KEY_SWITCHVIDEOMODE,0,KEY_SWITCHVIDEOMODE),
...
static RET berlin_ir_remove(struct platform_device *pdev)
{
